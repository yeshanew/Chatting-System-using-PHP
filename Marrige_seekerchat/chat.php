...
if(isset($_POST['image_id'])) {
    $sql = "SELECT * FROM user_account WHERE imageId=" . $_POST['image_id'];
...
<body class="animsition">
 ...
 <div class="au-chat-textfield">
                                                <form class="au-form-icon" id="chatForm" enctype="multipart/form-data" action="" method="post">
												<input name="message_type" id="message_type" type="hidden" value='text'>
                                                    <input class="au-input au-input--full au-input--h65" id="message_content" name="message_content" type="text" placeholder="Type a message">
